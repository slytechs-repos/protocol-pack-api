...
//		case long[] d        -> ArrayUtils.getShort(d, (int) byteOffset, context.order());
	 ...
	 * @param big        the big
	 * @return the byte
	 * @see com.slytechs.jnet.runtime.internal.layout.BitCarrier#setByte(byte,
...
//		case long[] d        -> ArrayUtils.putByte(d, (int) byteOffset, value);
	 ...
	 * @param big        the big
	 * @return the int
	 * @see com.slytechs.jnet.runtime.internal.layout.BitCarrier#setInt(int,
	 *      java.lang.Object, long)
	 */
	@Override
...
//		case long[] d        -> ArrayUtils.putInt(d, (int) byteOffset, value, context.order());
	 ...
	 * @param big        the big
	 * @return the long
	 * @see com.slytechs.jnet.runtime.internal.layout.BitCarrier#setLong(long,
	 *      java.lang.Object, long)
	 */
	@Override
...
//		case long[] d        -> ArrayUtils.putLong(d, (int) byteOffset, value, context.order());
	 ...
	 * @param big        the big
	 * @return the short
	 * @see com.slytechs.jnet.runtime.internal.layout.BitCarrier#setShortAtOffset(int,
