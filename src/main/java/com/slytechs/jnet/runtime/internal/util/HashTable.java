...
public interface HashTable<T> {
	...
	public interface OfLong extends HashTable<Long> {
		...
		/**
		 * @see com.slytechs.jnet.runtime.internal.util.HashTable#get(int)
		 */
		@Override
		...
		/**
		 * @see com.slytechs.jnet.runtime.internal.util.HashTable#peek(int)
		 */
		@Override
		...
		/**
		 * @see com.slytechs.jnet.runtime.internal.util.HashTable#put(int, java.lang.Object)
		 */
		@Override
