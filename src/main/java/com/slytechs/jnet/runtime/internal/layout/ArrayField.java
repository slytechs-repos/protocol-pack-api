...
import com.slytechs.jnet.runtime.internal.util.ByteArray;
...
public interface ArrayField extends BinaryField {
	...
	public interface Proxy extends ArrayField {
		...
		/**
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#getByteArrayAt(long, byte[], int, int, java.lang.Object)
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#getByteArray(byte[],
		 ...
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#getIntArray(int[],
		 *      int, int, java.lang.Object)
		 */
		 ...
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#getLongArray(long[],
		 *      int, int, java.lang.Object)
		 */
		 ...
		 * @param data   the data
		 * @return the short array
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#getShortArray(short[],
		 *      int, int, java.lang.Object)
		 */
		 ...
		 * @param data   the data
		 * @return the byte[]
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#setByteArray(byte[],
		 *      int, int, java.lang.Object)
		 */
		 ...
		 * @param data   the data
		 * @return the int[]
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#setIntArray(int[],
		 *      int, int, java.lang.Object)
		 */
		 ...
		 * @param data   the data
		 * @return the long[]
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#setLongArray(long[],
		 *      int, int, java.lang.Object)
		 */
		 ...
		 * @param data   the data
		 * @return the short[]
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#setShortArray(short[],
		 *      int, int, java.lang.Object)
		 */
		 ...
		 * @param sequences the sequences
		 * @return the byte array
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField#wrap(org.jnet.buffer.ByteArray,
		 *      long[])
		 */
	...
	class FormattedArrayField implements ArrayField.Proxy {
		 ...
		 * @param sequences the sequences
		 * @return the string
		 * @see com.slytechs.jnet.runtime.internal.layout.ArrayField.Proxy#toString(java.lang.Object,
		 *      long[])
		 */
		@Override
