...
import com.slytechs.jnet.runtime.internal.util.Attribute.Builtin;
import com.slytechs.jnet.runtime.internal.util.Attribute.Value;
...
public class AttributeBuffer extends MemoryBinding implements Iterable<Attribute.Value> {
	...
	private class Record extends MemoryBinding implements Value {
		...
		/**
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#addInt(int)
		 */
		@Override
		 ...
		 *
		 * @return the boolean
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getBoolean()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getByteArray()
		 */
		@Override
		 ...
		 *
		 * @return the double
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getDouble()
		 */
		@Override
		 ...
		 *
		 * @return the float
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getFloat()
		 */
		@Override
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getInt()
		 */
		@Override
		public int getInt() {
		 ...
		 *
		 * @return the long
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getLong()
		 */
		@Override
		public long getLong() {
		 ...
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getMemorySegment(java.lang.foreign.MemorySession)
		 */
		@Override
		 ...
		 *
		 * @return the short
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getShort()
		 */
		@Override
		 ...
		 *
		 * @return the string
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#getString()
		 */
		@Override
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#id()
		 */
		@Override
		public int id() {
			return id;
		...
		/**
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#incInt()
		 */
		@Override
		public int incInt() {
			return addInt(1);
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#offset()
		 */
		@Override
		public int offset() {
			return recordOffset;
		 ...
		 * @return the int
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#setInt(int)
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#valueBuffer()
		 */
		@Override
		 ...
		 *
		 * @return the int
		 * @see com.slytechs.jnet.runtime.internal.util.Attribute.Value#valueLength()
		 */
		@Override
	 ...
	 * @see com.slytechs.jnet.runtime.util.Attribute.Attributes#read(com.slytechs.jnet.runtime.internal.util.Attribute)
	 */
