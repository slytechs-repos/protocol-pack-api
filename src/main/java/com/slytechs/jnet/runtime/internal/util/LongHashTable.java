...
import com.slytechs.jnet.runtime.internal.util.HashTable.OfLong;
...
public abstract class LongHashTable implements OfLong {
	...
	public static class LongHash24Table extends LongHashTable {
		...
		/**
		 * @see com.slytechs.jnet.runtime.internal.util.LongHashTable#entry(int)
		 */
		@Override
	 ...
	 * @see com.slytechs.jnet.runtime.internal.util.HashTable.OfLong#getLong(int)
	 */
	@Override
	 ...
	 * @param key the key
	 * @return the long
	 * @see com.slytechs.jnet.runtime.internal.util.HashTable.OfLong#peekLong(int)
	 */
	@Override
	 ...
	 * @return the long
	 * @see com.slytechs.jnet.runtime.internal.util.HashTable.OfLong#putLong(int,
	 *      long)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.runtime.internal.util.HashTable#remove(int)
	 */
	@Override
	 ...
	 * Clear.
	 *
	 * @see com.slytechs.jnet.runtime.internal.util.HashTable#clear()
	 */
	@Override
	public void clear() {
		this.token++;
