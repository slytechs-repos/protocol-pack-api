...
public abstract class Pack<E extends Enum<? extends HeaderInfo>> {
	...
	private static class PackNotLoaded extends Pack<EmptyPack> {
		 ...
		 * @see com.slytechs.jnet.protocol.pack.Pack#isDetectable()
		 */
		@Override
		 ...
		 * @see com.slytechs.jnet.protocol.pack.Pack#isPackLoaded()
		 */
		@Override
		 ...
		 * @param id the id
		 * @return the header
		 * @see com.slytechs.jnet.protocol.pack.Pack#findHeader(int)
		 */
		@Override
	...
	private static class PackVariableOptions extends Pack<EmptyPack> {
		...
		/**
		 * @see com.slytechs.jnet.protocol.pack.Pack#isOptions()
		 */
		@Override
