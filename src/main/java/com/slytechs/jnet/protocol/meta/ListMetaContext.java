...
import com.slytechs.jnet.protocol.meta.MetaContext.MetaIndexed;
...
public class ListMetaContext extends AbstractMetaContext implements MetaIndexed {
	 ...
	 * @see com.slytechs.jnet.protocol.meta.MetaContext.MetaIndexed#append(java.lang.Object)
	 */
	@Override
	 ...
	 *
	 * @return the int
	 * @see com.slytechs.jnet.protocol.meta.MetaContext.MetaIndexed#capacity()
	 */
	@Override
	public int capacity() {
		return capacity;
	 ...
	 * @return the at index
	 * @see com.slytechs.jnet.protocol.meta.MetaContext.MetaIndexed#getAtIndex(int)
	 */
	 ...
	 *
	 * @return the int
	 * @see com.slytechs.jnet.protocol.meta.MetaContext.MetaIndexed#limit()
	 */
	@Override
	public int limit() {
		return list.size();
	 ...
	 * @param index the index
	 * @param value the value
	 * @see com.slytechs.jnet.protocol.meta.MetaContext.MetaIndexed#setAtIndex(int,
	 *      java.lang.Object)
	 */
	@Override
	 ...
	 * @param func     the func
	 * @see com.slytechs.jnet.protocol.meta.MetaContext.MetaIndexed#limit(int,
