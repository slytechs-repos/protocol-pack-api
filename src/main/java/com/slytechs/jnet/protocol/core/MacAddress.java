...
import com.slytechs.jnet.protocol.NetAddress;
import com.slytechs.jnet.protocol.NetAddressType;
import com.slytechs.jnet.protocol.core.constants.MacOuiAssignments;
import com.slytechs.jnet.protocol.core.constants.MacOuiAssignments.OuiEntry;
...
public class MacAddress implements NetAddress {
	 ...
	 *
	 * @return the byte[]
	 * @see com.slytechs.jnet.protocol.NetAddress#toArray()
	 */
	@Override
	public byte[] toArray() {
		return src;
	 ...
	 * @see com.slytechs.jnet.protocol.NetAddress#type()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.protocol.NetAddress#byteSize()
	 */
	@Override
	public int byteSize() {
