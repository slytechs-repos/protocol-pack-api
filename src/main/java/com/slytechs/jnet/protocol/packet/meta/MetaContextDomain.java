 ...
 *
 */
public class MetaContextDomain implements Cloneable, MetaContext_2 {
	...
	private final MetaContextDomain_2 parent;

	public MetaContextDomain() {
		this.parent = null;
	}

	public MetaContextDomain(MetaContextDomain_2 parent) {
		this.parent = parent;
	}
	 ...
	 */
	@Override
	public MetaContextDomain_2 clone() {
		MetaContextDomain_2 clone = new MetaContextDomain_2();
	...
	/**
	 * @see com.slytechs.jnet.protocol.packet.meta.MetaContext_2#searchField(java.lang.String)
	 */
	@Override
