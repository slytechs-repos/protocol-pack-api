...
public class MetaInfoContext implements MetaInfo.Proxy {
	...
	public MetaInfoContext(AnnotatedElement element, String name, JsonObject jsonDefaults) {
	...
	public <T extends MetaInfoType> T getMetaInfo(Class<T> type) {
