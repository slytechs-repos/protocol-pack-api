...
public interface MetaContext extends MetaDomain {
	...
	interface MetaMapped extends MetaContext {
		...
		public interface Proxy extends MetaMapped {
			 ...
			 *
			 * @return the int
			 * @see com.slytechs.protocol.meta.MetaContext.MetaMapped#capacity()
			 */
			@Override
			 ...
			 * @see com.slytechs.protocol.meta.MetaContext.MetaMapped#getOrCompute(java.lang.Object,
			 ...
			 *
			 * @return the int
			 * @see com.slytechs.protocol.meta.MetaContext.MetaMapped#remaining()
			 */
			@Override
			default int remaining() {
			 ...
			 * @param key   the key
			 * @param value the value
			 * @see com.slytechs.protocol.meta.MetaContext.MetaMapped#set(java.lang.Object,
			 *      java.lang.Object)
			 */
			@Override
