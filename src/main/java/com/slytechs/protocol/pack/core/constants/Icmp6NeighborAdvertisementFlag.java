...
import com.slytechs.protocol.runtime.util.IsIntBitmask;
import com.slytechs.protocol.runtime.util.IsIntFlag;
...
public enum Icmp6NeighborAdvertisementFlag implements IsIntFlag, IsIntBitmask {
	...
	/**
	 * @see com.slytechs.protocol.runtime.util.IsIntBitmask#getAsInt()
	 */
	@Override
	public int getAsInt() {
		return bits;
