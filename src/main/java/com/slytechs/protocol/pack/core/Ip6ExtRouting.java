 ...
 * </p>
 */
public final class Ip6ExtRouting extends Ip6Extension {
	...
	public enum RoutingType implements IntSupplier {
		 ...
		 */
		public static Ip6ExtRouting.RoutingType valueOf(int type) {
			for (Ip6ExtRouting.RoutingType t : values()) {
				if (t.type == type)
					return t;
			}
