...
import static com.slytechs.protocol.runtime.util.Bits.*;
...
//		}
		 ...
		 * @param offset         the offset
		 * @return the bit field context
		 * @see com.slytechs.protocol.runtime.internal.layout.FieldCarrierContext.CarrierBuilder#fromLayout(com.slytechs.protocol.runtime.internal.layout.SequenceLayout,
		 *      long)
		 */
		@Override
		 ...
		 * @param offset       the offset
		 * @return the bit field context
		 * @see com.slytechs.protocol.runtime.internal.layout.FieldCarrierContext.CarrierBuilder#fromLayout(com.slytechs.protocol.runtime.internal.layout.StructLayout,
		 *      long)
		 */
		@Override
		 ...
		 * @param offset      the offset
		 * @return the bit field context
		 * @see com.slytechs.protocol.runtime.internal.layout.FieldCarrierContext.CarrierBuilder#fromLayout(com.slytechs.protocol.runtime.internal.layout.UnionLayout,
		 *      long)
		 */
		@Override
...
//					System.out.printf("UionLayout::findBitField name=%s%n", value.layoutName().get());
		 ...
		 * @param offset the offset
		 * @return the bit field context
		 * @see com.slytechs.protocol.runtime.internal.layout.FieldCarrierContext.CarrierBuilder#fromLayout(com.slytechs.protocol.runtime.internal.layout.ValueLayout,
		 *      long)
		 */
		@Override
...
//			System.out.printf("StructSearch::value %s %s%n", value.layoutName().orElse(""), toString());
	...
	public static class CalculatedBitFieldContext extends BitFieldContext {
		 ...
		 * @return the long
		 * @see com.slytechs.protocol.runtime.internal.layout.FieldCarrierContext#carrierOffset(long)
		 */
		@Override
...
//			System.out.printf("BitFieldContext::carrierOffset off=%-2d alignMask=0x%X%n", off, alignMask);
		 ...
		 * @param strideOffset the stride offset
		 * @return the int
		 * @see com.slytechs.protocol.runtime.internal.layout.BitFieldContext#fieldBitshift(long)
		 */
		@Override
